                ...
                <div id="login-box" class="login-box visible widget-box no-border">
                  <div class="widget-body">
                    <div class="widget-main">
                      ...
                      <form id="frmtoken" name="frmtoken" method="post" action="<?php echo base_url('tarjeta/acceso') ?>" autocomplete="off">
                        <input type="hidden" name="idtarjeta" id="idtarjeta" value="<?php echo $idtarjeta ?>"> 
                      ...
                      <form name="frm_tarjeta" id="frm_tarjeta">
                        <fieldset>
                          <label class="block clearfix">
                            Nº Tarjeta
                            <span class="block input-icon input-icon-right">
                              <input type="text" id="digitos" class="form-control" readonly />
                              <i class="ace-icon fa fa-hashtag"></i>
                            </span>
                          </label>
                          ...
                          <label class="block clearfix">
                            CVV
                            <span class="block input-icon input-icon-right">
                              <input type="text" id="cvv" class="form-control" readonly />
                              <i class="ace-icon fa fa-hashtag"></i>
                            </span>
                          </label>
                          ...
                          <label class="block clearfix">
                            EXP
                            <span class="block input-icon input-icon-right">
                              <input type="text" id="exp" class="form-control" readonly />
