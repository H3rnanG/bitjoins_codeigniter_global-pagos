          ...
          <div class="page-content">
            <div class="row">
              <div class="col-xs-12">
                ...
                <h2 class="header smaller lighter orange">Destinos</h2>
                ...
                <div class="sidebar h-sidebar navbar-collapse ace-save-state">
                 ...
                 <div class="tab-content">
                   <div class="tab-pane in active" id="home">
                    ...
                    <table id="reporte" class="table table-bordered table-hover reporte" width="100%" data-action="<?php echo site_url('admin/ajax_vista_pais')?>">
                      <thead>
                          <tr>
                              <th></th>
                              <th>Item</th>
                   ...
                   <div class="tab-pane" id="form" data-action="<?php echo base_url('admin/get_pais') ?>">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          ...
                          <div class="col-md-8">
                            <form name="frm" id="frm" method="post" class="frmreg" action="<?php echo base_url('admin/grabar_pais'); ?>" >

                            <div class="row">
                              <div class="col-sm-6" >
                                <label>Nombre</label>
                                <input type="hidden" name="id" id="id">
                                <input type="text" name="nombre" id="nombre" class="form-control camp_nombre">
                              </div>  
                            </div>
                            <br>
                            <div class="row">
                              <div class="col-sm-2" >
                                <label>Zona FDX</label>
                                <input type="text" name="zona_fdx_ie" id="zona_fdx_ie" class="form-control camp_zona_fdx_ie">
                              </div>  
                              <div class="col-sm-2" >
                                <label>Zona DHL</label>
                                <input type="text" name="zona_dhl_ie" id="zona_dhl_ie" class="form-control camp_zona_dhl_ie">
                              </div>  
                            </div>
                            <br>
