...
<html lang="es">
  <head>
    ...
    <meta charset="utf-8" />
    <title>Administrador - Pais </title>
          ...
          <div class="page-content">
            <div class="row">
              <div class="col-xs-12">
                ...
                <h2 class="header smaller lighter orange">Tarifa por Peso</h2>
                ...
                <div class="sidebar h-sidebar navbar-collapse ace-save-state">
                 ...
                 <div class="tab-content">
                   <div class="tab-pane in active" id="home">
                    ...
                    <table id="reporte" class="table table-bordered table-hover reporte" width="100%" data-action="<?php echo site_url('admin/ajax_vista_tarifario')?>">
                      <thead>
                          <tr>
                              <th></th>
                              <th>Item</th>
                   ...
                   <div class="tab-pane" id="form" data-action="<?php echo base_url('admin/get_tarifario') ?>">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          ...
                          <div class="col-md-8">
                            <form name="frm" id="frm" method="post" class="frmreg" action="<?php echo base_url('admin/grabar_tarifario'); ?>" >
                              <input type="hidden" name="id" id="id">

                            <div class="row">
                              <div class="col-sm-4">
                                <label>Agencia</label>
                                <select name="calculadora_agencia_id" id="calculadora_agencia_id" class="form-control" >
                                  <option value="<?php echo AG_FDX; ?>" >FEDEX</option>
                                  <option value="<?php echo AG_DHL; ?>" >DHL</option>
                                </select>
                              </div>
                            </div>
                            <br>
                            <div class="row">
                              ...
                              <div class="col-sm-2" >
                                <label>Peso</label>
                                <input type="number" name="peso" id="peso" class="form-control camp_peso" step="any">
                              </div>  
                            </div>
                            <br>
                            <div class="row">
                              <div class="col-sm-2" >
                                <label>Zona 1</label>
                                <input type="number" name="zona1" id="zona1" class="form-control" step="any" >
                              </div>  
                              <div class="col-sm-2" >
                                <label>Zona 2</label>
                                <input type="number" name="zona2" id="zona2" class="form-control" step="any">
                              </div>  
                              <div class="col-sm-2" >
                                <label>Zona 3</label>
                                <input type="number" name="zona3" id="zona3" class="form-control" step="any">
                              </div>  
                            </div>
                            <br>
                            <div class="row">
                              <div class="col-sm-2" >
                                <label>Zona 4</label>
                                <input type="number" name="zona4" id="zona4" class="form-control" step="any">
                              </div>  
                              <div class="col-sm-2" >
                                <label>Zona 5</label>
                                <input type="number" name="zona5" id="zona5" class="form-control" step="any">
                              </div>  
                              <div class="col-sm-2" >
                                <label>Zona 6</label>
                                <input type="number" name="zona6" id="zona6" class="form-control" step="any">
                              </div>  
                            </div>
                            <br>
