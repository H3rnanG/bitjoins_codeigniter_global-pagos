                ...
                <div class="sidebar h-sidebar navbar-collapse ace-save-state">
                 ...
                 <div class="tab-content">
                   <div class="tab-pane in active" id="home">
                    ...
                    <table id="reporte" class="table table-bordered table-hover reporte" width="100%" data-action="<?php echo site_url('admin/ajax_vista_cajero')?>">
                      <thead>
                          <tr>
                              <th></th>
                              <th>Item</th>
                   ...
                   <div class="tab-pane" id="form" data-action="<?php echo base_url('admin/get_cajero') ?>">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          ...
                          <div class="col-md-8">
                            <form name="frm" id="frm" method="post" class="frmreg" action="<?php echo base_url('admin/grabar_cajero'); ?>" >
                            ...
                            <div class="row">
                              <div class="col-sm-3" >
                                <label>Comisión Cargo</label>
                                <input type="text" name="comision_cargo" id="comision_cargo" class="form-control" >
                              </div>  
                              <div class="col-sm-3" >
                                <label>Dsct. TC</label>
                                <input type="text" name="tc_dscto" id="tc_dscto" class="form-control" >
                              </div>  
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <select name="login_parent" id="login_parent" class="form-control">
                            ...
                            <div class="row">
                              <div class="col-sm-9">
                                <label>Carpeta Local</label>
                                <input type="text" name="rutalocal" id="rutalocal" class="form-control" >
                              </div>
                            </div><!--/row-->
