	...
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<h3 class="display-4">AstroPay card</h3>
			<p class="lead">No pudimos validar la operación, puede contactarnos via whatsApp o por correo con el nro de su operación: <strong><u><?php echo $apc_codventa; ?></u></strong>.</p>
		</div>
	</div>
