				  	...
				  	<div class="row justify-content-center">
						<div class="col-12 col-sm-8">
							<div class="form-group row caja-1">
							  <label for="monto_recarga" class="col-6 col-sm-2 col-form-label">Ingresa el monto en $</label>
							  <div class="col-6">
				  ...
				  <div class="tab-pane fade" id="paso2" role="tabpanel">
				  	...
				  	<div class="row justify-content-center">
				  		...
				  		<div class="col-12 col-sm-6">
							  ...
							  <div class="col-5 text-center">
							  	<img src="<?php echo base_url('assets/images/logo-khipu.png') ?>" alt="KHIPU" width="120" >
							  	<br>
							  	<input type="radio" name="metodopago" id="metodopago" class="form-control chk-metodo-pago" checked value="<?php echo MP_KHIPU ?>" >
							  	<br>
							  </div>
							</div>
							<div class="row justify-content-center">
								<div class="col-sm-11">
									<p>
										<u><strong>COMISIÓN KHIPU:</strong></u> <?php echo COMISION_KP ?> CLP
									</p>
									<ul>
									...
									<div class="text-center">
										<iframe width="350" height="210" src="https://www.youtube.com/embed/DCji5TqmJGE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
									</div>
						  		</div>
							</div>
						...
						<div class="col-12 col-sm-6">
							  ...
							  <div class="col-10">
							  	<div class="text-center">
							  		<img src="<?php echo base_url('assets/images/santander-logo.png') ?>" alt="BANCO" width="100" >	
							  	</div>
							  	<input type="radio" name="metodopago" id="metodopago" class="form-control chk-metodo-pago" value="<?php echo MP_BANCHILE ?>">
							  	<br>
							  	<p><u><strong>Comisión por compras menores a $50 dolares:</strong></u> $1.00 Dolar</p>
								
								<div class="row caja-1 justify-content-center">
								  <div class="col-md-4 label">Banco:</div>
								  <div class="col-md-7 info info-nroope">Santander</div>
								</div>

								<div class="row caja-2 justify-content-center">
								  <div class="col-md-4 label">Producto:</div>
								  <div class="col-md-7 info info-cantdolares">Cuenta Corriente</div>
								</div>

								<div class="row caja-2 justify-content-center">
								  <div class="col-md-4 label">Nro. de cuenta:</div>
								  <div class="col-md-7 info info-cantpesos">74 300 995</div>
								</div>

								<div class="row caja-1 justify-content-center">
								  <div class="col-md-4 label">RUT:</div>
								  <div class="col-md-7 info info-comision">77.019.428-8</div>
								</div>

								<div class="row caja-1 justify-content-center">
								  <div class="col-md-4 label">Empresa:</div>
								  <div class="col-md-7 info info-comision">Soluciones Digitales SpA</div>
								</div>

								<div class="row caja-3 justify-content-center">
								  <div class="col-md-4 label">Soporte:</div>
								  <div class="col-md-7 info info-totaloperacion"> <a href="mailto:soporte@astopaycard.cl">soporte@astopaycard.cl</a> </div>
								</div>
					...
					<div class="row caja-3 justify-content-center">
					  <div class="col-md-6 text-left">
							<button type="button" class="btn btn-inverse btn-regresa" data-index="2"> VOLVER</button>
						</div>
