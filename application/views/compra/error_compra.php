	...
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
		<h3 class="display-3">AstroPay card</h3>
		<p class="lead">Ocurrio un Error puede contactarnos dando <a href="<?php echo base_url('contacto') ?>">click aquí</a>.</p>
    <p class="lead">Si desea regresar a <a href="<?php echo base_url('comprar'); ?>">comprar click aquí</a>.</p>
		</div>
	</div>
