...
<form name="frmContacto" id="frmContacto" method="post" >
	<div class="container contenido border-content">	
		<div class="row">
			...
			<div class="col-sm-12">
				<br><h1 class="titulo-1">¿Interesado en contactarnos?</h1><br>
				<div class="msjFrmContacto" role="alert"></div> 
	      	</div>
		</div>
			...
			<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-12"> 
						...
						<input type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombres"  autofocus>
						</p>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12"> 
						<p>
						<label for="nombre"><span>*</span>Teléfono</label>
						<input type="text" name="fono" id="fono" class="form-control" placeholder="Teléfono" >
						</p>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12"> 
						...
						<textarea name="mensaje" id="mensaje" class="form-control" rows="5" placeholder="Mensaje" ></textarea>
						</p>
						<p>
				...
				<div class="row">
					<div class="col-sm-4"> 
						<button type="submit" class="btn btn-danger g-recaptcha" data-sitekey="reCAPTCHA_site_key" 
...
<!-- FIN SECCIÓN -->
	...
	<script>
	MyApp.contacto.init("<?php echo base_url('contacto/enviar') ?>");
	</script>
