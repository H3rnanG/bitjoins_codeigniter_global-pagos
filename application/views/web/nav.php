...
<div class="sidebar-info">
  <div class="container">
    <nav class="navbar navbar-expand-lg">
      ...
      <ul class="navbar-nav mr-auto float-right navbar-usuario">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('usuario/login') ?>">Ingresar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('usuario') ?>">Registrarse</a>
        </li>
        <li class="nav-item">
