...
<table class="table-row" width="450" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; table-layout: fixed;"><tbody><tr><td class="table-row-td" valign="top" align="left" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 36px; padding-right: 36px;">
  <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="table-col-td" width="378" valign="top" align="left" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;">
    ...
    <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
      ...
      <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
      	<?php 
      	//$linkmap = 'https://www.google.com/maps/@'.$latlong.',15z'; 
      	$linkmap = 'https://maps.google.com/?ll='.$latlong.'&z=5';
      	?>
        Ubicación: <a href="<?php echo $linkmap ?>" target="_blank" ><?php echo $pais.' - '.$ciudad ?></a> 
      </p>
      <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
        Fecha / Hora: <?php echo date('d-m-Y').' - '.date('H:i:s') ?>
      </p>
      <p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px;">
        IP: <?php echo $ip ?>
      </p>
      <p>Observación: <?php echo $msg ?></p>
      <p>
      	AstroPay card
      </p>
      <br>
...
<table class="table-row" width="450" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; table-layout: fixed;"><tbody><tr><td class="table-row-td" valign="top" align="left" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 36px; padding-right: 36px;">
  <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="table-col-td" width="378" valign="top" align="left" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;">
    <div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">
      <a href="<?php echo $linkmap; ?>" target="_blank" style="background-color: #b3373c; color: #ffffff; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #91383c; padding: 4px 9px; font-size: 15px; line-height: 21px;">UBICACIÓN EN EL MAPA</a>
    </div>
