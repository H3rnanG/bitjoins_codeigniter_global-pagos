...
<div class="banner-interna">
 ...
 <form name="frmdatos" id="frmdatos" method="post" action="<?php echo base_url('usuario/registro') ?>" >
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6">
				<label class="control-label"><strong><span class="text-danger">*</span>Nombres</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-user"></i></span>
				  	</div>
				  	<input name="nombres" id="nombres" placeholder="Nombres" class="form-control"  type="text" tabindex="1">
				</div>
			</div>

			<div class="col-sm-6">
				<label class="control-label"><strong><span class="text-danger">*</span>Apellidos</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-user"></i></span>
				  	</div>
				  	<input name="apellidos" id="apellidos" placeholder="Apellidos" class="form-control"  type="text" tabindex="2">
				</div>
			</div>
		</div>
		<div class="space"></div>
		...
		<div class="row">
			<div class="col-sm-6">
				<label class="control-label"><strong><span class="text-danger">*</span>E-Mail (Usuario)</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-envelope"></i></span>
				  	</div>
				  	<input name="usuario" id="usuario" placeholder="E-Mail" class="form-control" type="text" tabindex="3">
				</div>
			</div>

			<div class="col-sm-6">
				<label class="control-label"><strong><span class="text-danger">*</span>Confirmar E-Mail</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-envelope"></i></span>
				  	</div>
				  	<input name="confusuario" id="confusuario" placeholder="E-Mail" class="form-control" type="text" tabindex="4">
				</div>
			</div>
		</div>
		<div class="space"></div>
		...
		<div class="row">
			<div class="col-sm-6">
				<label class="control-label"><strong><span class="text-danger">*</span>Password</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-key"></i></span>
				  	</div>
				  	<input name="pass" id="pass" class="form-control" type="password" tabindex="5">
				</div>
			</div>

			<div class="col-sm-6">
				<label class="control-label"><strong><span class="text-danger">*</span>Confirmar Password</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-key"></i></span>
				  	</div>
				  	<input name="passconf" id="passconf" class="form-control" type="password" tabindex="6">
				</div>
			</div>
		...
		<div class="row">
			<div class="col-sm-3">
				<label class="control-label"><strong><span class="text-danger">*</span>Celular</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-mobile"></i></span>
				  	</div>
				  	<input name="celular" id="celular" placeholder="Celular" class="form-control" type="number" tabindex="7" maxlength="9" >
				</div>
			</div>
			
			<div class="col-sm-3" >
				<label class="control-label"><strong><span class="text-danger">*</span>WhatsApp</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-whatsapp"></i></span>
				  	</div>
				  	<input name="nrowsp" id="nrowsp" placeholder="Nro. de WhatsApp" class="form-control"  type="number" tabindex="8" maxlength="9" >
				</div>
			</div>

			<div class="col-sm-3">
				<label class="control-label"><strong><span class="text-danger">*</span>Tipo Doc</strong></label>  
				<select name="tipodoc" id="tipodoc" class="form-control" tabindex="9">
			    	<option value="1">Cedula de identidad</option>
			    	<option value="2">Passaporte</option>
			    	<option value="3">CI Extranjeros</option>
			    </select>
			</div>

			<div class="col-sm-3">
				<label class="control-label"><strong><span class="text-danger">*</span>Nº Documento</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-list-alt"></i></span>
				  	</div>
				  	<input name="documento" id="documento" placeholder="Nº Documento" class="form-control" type="text" tabindex="10"  maxlength="15">
				</div>
			</div>
			...
			<div class="col-sm-6">
				...
				<div class="input-group">
				    <div class="input-group-prepend">
				  	...
				  	<input name="direccion" id="direccion" placeholder="Dirección" class="form-control"  type="text" tabindex="11"  maxlength="200" >
				</div>
			</div>

			<div class="col-sm-3">
				<label class="control-label"><strong>Comuna - Región</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-map-marker"></i></span>
				  	</div>
				  	<input type="text" maxlength="150" name="distrito" id="distrito" class="form-control" tabindex="12" maxlength="150">
				</div>
			</div>
			
			<div class="col-sm-3">
				<label class="control-label"><strong>Nacionalidad</strong></label>  
				<div class="input-group">
				    <div class="input-group-prepend">
					    <span class="input-group-text"><i class="fa fa-flag"></i></span>
				  	</div>
				  	<input name="nacionalidad" id="nacionalidad" placeholder="Nacionalidad" class="form-control"  type="text" tabindex="13"  maxlength="50" >
				</div>
			</div>
		</div>
		<div class="space"></div>
		...
		<div class="row">
			<div class="col-sm-9">
				<div class="checkbox">
				    <label>
				      <a href="#"  data-toggle="modal" data-target="#myModalTerminos" ><span class="text-danger">*</span><u>Debe leer y aceptar los terminos y condiciones del servicio.</u></a> &nbsp; <input type="checkbox" name="chktermino" id="chktermino" class="checkbox-lg" tabindex="8" > 
				    </label>
			  	</div>
			</div>
			<div class="col-sm-3 text-right">
				<input type="hidden" name="keyform" id="keyform" value="<?php echo $keyform; ?>">
				<button type="submit" class="btn btn-danger"><i class="fa fa-send" tabindex="14"></i> REGISTRATE</button>
			</div>
		</div>
		<br>
		<h4><u>Complete sus datos con información veraz para su perfil de usuario, completando los datos correctamente no tendra inconvenientes para comprar sus tarjetas:</u></h4>		
		<br>
