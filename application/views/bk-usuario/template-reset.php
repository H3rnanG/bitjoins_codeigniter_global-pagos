...
<table class="table-row" width="450" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; table-layout: fixed;"><tbody><tr><td class="table-row-td" valign="top" align="left" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 36px; padding-right: 36px;">
  <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="table-col-td" width="378" valign="top" align="left" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;">
    <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="header-row-td" width="378" valign="top" align="left" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #1e1c1e; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;">
    	...
    	<br><br>
    	Para actualizar su password debe dar click en el enlace:
    </td></tr></tbody></table>
...
<table class="table-row" width="450" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; table-layout: fixed;"><tbody><tr><td class="table-row-td" valign="top" align="left" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 36px; padding-right: 36px;">
  <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="table-col-td" width="378" valign="top" align="left" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;">
    <div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">
      <a href="<?php echo base_url('usuario/frmresetpass/'.$usuario.'/'.$token); ?>" style="background-color: #b3373c; color: #ffffff; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #91383c; padding: 4px 9px; font-size: 15px; line-height: 21px;">CLICK AQUÍ</a>
      <br><br>
      <p>Si no puede dar click en el enlace, copie y pega la siguiente url:<br><br>
      	<strong> <u><i> <?php echo base_url('usuario/frmresetpass/'.$usuario.'/'.$token); ?></i></u></strong></p>
    </div>
...
<table class="table-row-fixed" width="450" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; table-layout: fixed;"><tbody><tr><td class="table-row-fixed-td" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 1px; padding-right: 1px;" valign="top" align="left">
  <table class="table-col" align="left" width="448" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td class="table-col-td" width="448" valign="top" align="left" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal;">
    <table width="100%" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td width="100%" align="center" bgcolor="#f5f5f5" valign="top" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; background-color: #f5f5f5; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3;">
      <a href="#" style="background-color: transparent; color: #1e1c1e;">AstroPay card PE &copy; <?php echo date('Y') ?></a>
      <br>
    </td></tr></tbody></table>
  </td></tr></tbody></table>
</td></tr></tbody></table>
