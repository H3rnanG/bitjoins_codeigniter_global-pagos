...
<div class="banner-interna">
 ...
 SECCIÓN -->
	...
	<div class="container">
		...
		<!-- Text input-->
		<br>
		<h2>Debe ingresar los datos para completar su registro:</h2>
		<div class="row">
			<div class="col-sm-8">
				    ...
				    <div class="inputGroupContainer">
					    <div class="input-group">
					        <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
					  		<input name="direccion" id="direccion" placeholder="Dirección" class="form-control"  type="text" tabindex="1" >
					    </div>
				  	</div>
				</div>
			</div>
			...
			<div class="col-sm-4">
				...
				<input type="text" maxlength="150" name="distrito" id="distrito" class="form-control" tabindex="2">
			</div>
		</div>
				    ...
				    <div class="inputGroupContainer">
					    <div class="input-group">
					        <span class="input-group-addon"><i class="fa fa-phone"></i></span>
					  		<input name="telefono" id="telefono" placeholder="Teléfono Fijo" class="form-control"  type="text" tabindex="3" >
					    </div>
				  	</div>
				</div>
			</div>
				    ...
				    <div class="inputGroupContainer">
					    <div class="input-group">
					        <span class="input-group-addon"><i class="fa fa-mobile"></i></span>
					  		<input name="celular" id="celular" placeholder="Celular" class="form-control"  type="text" tabindex="4" >
					    </div>
				  	</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
					<label class="control-label">Nº Billetera AstroPay card</label>  
				    <div class="inputGroupContainer">
					    <div class="input-group">
					        <span class="input-group-addon"><i class="fa fa-credit-card-alt"></i></span>
					  		<input name="billetera" id="billetera" placeholder="56+ " class="form-control"  type="text" tabindex="5" value="+56 " >
					    </div>
				  	</div>
				</div>
			</div>
		...
		<div class="row">
				    ...
				    <div class="inputGroupContainer">
					    <div class="input-group">
					        <span class="input-group-addon"><i class="fa fa-flag"></i></span>
					  		<input name="nacionalidad" id="nacionalidad" placeholder="Nacionalidad" class="form-control"  type="text" tabindex="6" >
					    </div>
				  	</div>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div class="form-group">
				    ...
				    <select name="tipodoc" id="tipodoc" class="form-control" tabindex="7">
				    	<option value="1">CEDULA DE IDENTIDAD</option>
				    	<option value="2">PASSAPORTE</option>
				    	<option value="3">CEDULA DE INDENTIDAD EXTRANJEROS</option>
				    </select>
				</div>
			</div>
				    ...
				    <div class="inputGroupContainer">
					    <div class="input-group">
					        <span class="input-group-addon"><i class="fa fa-list-alt"></i></span>
					  		<input name="documento" id="documento" placeholder="Nº Documento" class="form-control" type="text" tabindex="8" >
					    </div>
				  	</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-sm-3">
				<button type="submit" class="btn btn-danger"><i class="fa fa-send"></i> CONFIRMAR DATOS</button>	
			</div>
			<div class="col-sm-9">
				<div class="checkbox">
				    <label>
