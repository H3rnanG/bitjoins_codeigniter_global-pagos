                 ...
                 <div class="tab-content">
                   <div class="tab-pane in active" id="home">
                     ...
                     <form name="frm2" id="frm2" method="POST">
                      ...
                      <br>
                      <table id="rpt_locales" class="table table-bordered table-hover reporte" width="100%" data-action="<?php echo site_url('calculadora/ajax_vista_ventas_tienda')?>">
                        <thead>
                            <tr>
                                <th>Item</th>
                                <th>Local</th>
                     ...
                     <form name="frm3" id="frm3" method="POST">
                      ...
                      <br>
                      <table id="rpt_usuarios" class="table table-bordered table-hover reporte" width="100%" data-action="<?php echo site_url('calculadora/ajax_vista_ventas_usuario')?>">
                        <thead>
                            <tr>
                                <th>Item</th>
                                <th>Usuario</th>
