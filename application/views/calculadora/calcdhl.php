                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-5">
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-8">
                                  <button type="button" id="btndhl" class="btn btn-yellow pull-right" data-act="<?php echo base_url('calculadora/get_dhl') ?>"> <i class="fa fa-calculator"></i> COTIZAR</button>
                                </div>
                              </div><!-- / row -->
                              ...
                              <div class="row">
                                <div class="col-sm-8">
                                  <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" id="cotidhl" name="cotidhl" readonly >
                                    <span class="input-group-addon dhlklg1">1KL</span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-sm-8">
                                  <div class="input-group">
                                    <span class="input-group-addon">CLP</span>
                                    <input class="form-control" type="text" id="cotidhl10" name="cotidhl10" readonly >
                                    <span class="input-group-addon dhlklg10">10KL</span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-sm-8">
                                  <div class="input-group">
                                    <span class="input-group-addon">CLP</span>
                                    <input class="form-control" type="text" id="cotidhl20" name="cotidhl20" readonly >
                                    <span class="input-group-addon dhlklg20">20KL</span>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="col-sm-3 text-center">
                              <img src="<?php echo base_url('assets/images/calculadora/logo-dhl.png') ?>" class="img-responsive" >
                            </div>
