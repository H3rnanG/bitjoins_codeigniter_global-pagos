...
<html lang="es">
  ...
  <body class="no-skin">
      ...
      <?php echo $tmp_nav; ?>
        ...
        <div class="main-content">
          ...
          <div class="page-content">
            ...
            <h2 class="header smaller blue">CALCULADORA MORE PAYMENT</h2>
                ...
                <div class="sidebar h-sidebar navbar-collapse ace-save-state">
                  <ul id="tabseccion" class="nav nav-list" >
                   ...
                   <li>
                      <a href="#form" data-toggle="tab">
                        ...
                        <span class="menu-text"> Colombia </span>
                      </a>
                   </li>
                  </ul>
                  <div class="tab-content">
                    <div class="tab-pane in active" id="home">
                      ...
                      <form name="frm" id="frm" method="POST" target="_blank" action="<?php echo base_url('calculadora/ticket_billetera') ?>">
                        <div class="row">
                            <div class="col-md-12">
                              <div class="widget-box">
                                 <div class="widget-header">
                                    <h4 class="widget-title smaller">
                                      <i class="ace-icon fa fa-ticket"></i><span>Transferencia de Remesas</span>
                                    </h4>
                                 </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                              <label><input type="radio" name="opt" id="opt" class="opt form-control co_cl1" value="1" checked> Formato 1</label>
                                            </div>
                                            <div class="col-sm-4">
                                              <label><input type="radio" name="opt" id="opt" class="opt form-control co_cl2" value="2"> Formato 2</label>
                                            </div>
                                          </div>
                                        ...
                                        <div class="col-sm-3 text-center">
                                          <div class="space-6"></div>
                                          <img src="<?php echo base_url('assets/images/calculadora/logo-more-payment.png') ?>" class="img-responsive" >
                                          <div class="space-6"></div>
                    ...
                    <div class="tab-pane" id="form">
                      ...
                      <form name="frmco" id="frmco" method="POST" target="_blank" action="<?php echo base_url('calculadora/ticket_billetera_colombia') ?>">
                        <div class="row">
                            <div class="col-md-12">
                              <div class="widget-box">
                                 <div class="widget-header">
                                    <h4 class="widget-title smaller">
                                      <i class="ace-icon fa fa-ticket"></i><span>Transferencia Colombia</span>
                                    </h4>
                                 </div>
                                 <div class="widget-body">
                                    <div class="widget-main">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                          ...
                                          <input type="hidden" name="co_ing_pais" id="co_ng_pais">

                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <span class="input-group-addon">MONTO&nbsp;&nbsp;</span>
                                                <input class="form-control" type="text" id="co_ing_mnt" name="co_ing_mnt" autocomplete="off"> <!--  -->
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <span class="input-group-addon">CARGO&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                <input class="form-control" type="text" id="co_ing_crg" name="co_ing_crg" autocomplete="off" >
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <input type="hidden" id="co_ing_tipo" name="co_ing_tipo" value="1" >
                                          <input type="hidden" id="co_ing_com" name="co_ing_com" >

                                          <div class="row">
                                            <div class="col-sm-5">
                                              <div class="input-group">
                                                <span class="input-group-addon">% IVA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                <input type="number" name="co_ing_iva" id="co_ing_iva" value="19" readonly>
                                              </div>
                                            </div>
                                            ...
                                            <div class="col-sm-7">
                                              <div class="input-group">
                                                <span class="input-group-addon">T. IVA</span>
                                                <input class="form-control" type="number" id="co_ing_tiva" name="co_ing_tiva" readonly >
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <span class="input-group-addon">TOTAL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                <input class="form-control" type="text" id="co_ing_tot" name="co_ing_tot" readonly >
                                                <span class="input-group-addon">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-6">
                                              <div class="input-group">
                                                ...
                                                <input class="form-control" type="number" step="any" id="co_ing_tc" name="co_ing_tc" >
                                              </div>
                                            </div>
                                            <div class="col-sm-6">
                                              <div class="input-group">
                                                <span class="input-group-addon">TC ACT.</span>
                                                <input class="form-control" type="number" step="any" id="co_ing_tcact" name="co_ing_tcact" readonly >
                                              </div>
                                            </div>
                                            <input class="form-control" type="hidden" step="any" id="co_ing_dct" name="co_ing_dct" value="<?php echo $dscto; ?>" >
                                          </div>
                                          <div class="space-6"></div>
                                          <div class="row">
                                          ...
                                          <div class="row">
                                            <div class="col-sm-9">
                                              <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" step="any" id="co_ing_appago" name="co_ing_appago" >
                                              </div>
                                            </div>
                                            <div class="col-sm-3">
                                              <button type="button" id="co_btnrefresh" class="btn btn-primary btn-sm pull-right" > 
                                                <i class="fa fa-refresh"></i> CALCULAR
                                              </button>
                                            </div>
                                          </div>
                                        ...
                                        <div class="col-sm-4">
                                          ...
                                          <input type="hidden" name="co_ori_pais" id="co_ori_pais" value="2">
                                          <input type="hidden" name="co_ori_mnt" id="co_ori_mnt">
                                          <input type="hidden" name="co_ori_crg" id="co_ori_crg">
                                          <input type="hidden" name="co_ori_tipo" id="co_ori_tipo">
                                          <input type="hidden" name="co_ori_com" id="co_ori_com">
                                          <input type="hidden" name="co_ori_iva" id="co_ori_iva">

                                          <input type="hidden" name="co_ori_tiva" id="co_ori_tiva">
                                          <input type="hidden" name="co_ori_dct" id="co_ori_dct">
                                          <input type="hidden" name="co_ori_tc" id="co_ori_tc">
                                          <input type="hidden" name="co_ori_tcact" id="co_ori_tcact">
                                          <input type="hidden" name="co_ori_appago" id="co_ori_appago">

                                          <input type="hidden" name="co_edt_tc" id="co_edt_tc" >
                                          <input type="hidden" name="co_edt_appago" id="co_edt_appago" >
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <span class="input-group-addon">MONTO&nbsp;&nbsp;</span>
                                                <input class="form-control" type="text" id="co_edt_mnt" name="co_edt_mnt" readonly >
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <span class="input-group-addon">CARGO&nbsp;&nbsp;</span>
                                                <input class="form-control" type="text" id="co_edt_crg" name="co_edt_crg" readonly >
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <span class="input-group-addon">IVA&nbsp;&nbsp;</span>
                                                <input class="form-control" type="text" id="co_edt_iva" name="co_edt_iva" readonly >
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <span class="input-group-addon">SUB. TOT</span>
                                                <input class="form-control" type="text" id="co_edt_sbt" name="co_edt_sbt" readonly >
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <span class="input-group-addon">TOTAL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                <input class="form-control" type="text" id="co_edt_tot" name="co_edt_tot" readonly >
                                                <span class="input-group-addon fdxklg10">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <label for="adjticket">Adjuntar PDF</label>
                                              <input type="file" name="adjticket" id="co_my-file-input-1" class="co_file-adj" data-frm="#frmco" data-action="<?php echo base_url('calculadora/upload_ticket'); ?>" data-carpeta="<?php echo base_url('uploads/') ?>" />
                                              <input type="hidden" name="co_adjunto" id="co_adjunto">
                                            </div>
                                          </div>

                                          <div class="space-6"></div>
                                          <div class="row">
                                            <input type="hidden" name="co_edt_formato" id="co_edt_formato" value="<?php echo $formato; ?>">
                                            <div class="col-sm-4">
                                              <label><input type="radio" name="opt" id="co_opt" class="co_opt form-control co_cl1" value="1" checked> Formato 1</label>
                                            </div>
                                            <div class="col-sm-4">
                                              <label><input type="radio" name="opt" id="co_opt" class="co_opt form-control co_cl2" value="2"> Formato 2</label>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <button type="button" id="co_btn-procesar" class="btn btn-primary btn-sm pull-right"><i class="fa fa-file-pdf-o"></i> PROCESAR</button>
                                            </div>
                                          </div>
                                        ...
                                        <div class="col-sm-3 text-center">
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <input class="form-control" type="text" id="co_utilidad" name="co_utilidad" readonly >
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <label>Nro. Boleta</label>
                                              <input class="form-control" type="text" id="co_nroboleta" name="co_nroboleta" >
                                              <!--
                                              <br>
                                              <button type="button" class="btn btn-app btn-primary btn-facturar">
                                                <i class="ace-icon fa fa-usd bigger-230"></i>
    ...
    <script type="text/javascript"> 
        ...
        var v_utility_min = '<?php echo $v_UTILIDAD ?>';
        var v_nro_rut = '<?php echo $v_nro_rut ?>';

        //MyApp.ticket_morepayment.init();
        MyApp.ticketwestern_integrado.init();
        MyApp.ticketwestern_colombia.init();

        //$("#ing_pais").val("2").trigger("change");
        $('#ori_pais').val(1);
    </script>
