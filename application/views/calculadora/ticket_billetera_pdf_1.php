...
if(strlen($formato)>0){
    ...
    coverWithLabelTCPDF($obpdf, 14, 197, 48, 16, 'Envíos');
    ...
    if($mnt_total){
        ...
        coverWithLabelTCPDF($obpdf, 90.5, 232, 25, 6.5, $mnt_total_2,'R','',3);
    } // fin if mnt_total

    if($edt_crg){
        $edt_crg_2 = number_format($edt_crg, 2, '.', ',');
        coverWithLabelTCPDF($obpdf, 90.5, 238, 25, 6.5, $edt_crg_2,'R','',3);
    }

    if($edt_sbt){
        $edt_sbt_2 = number_format($edt_sbt, 2, '.', ',');
        coverWithLabelTCPDF($obpdf, 90.5, 251.5, 25, 6.5, $edt_sbt_2,'R','',3);
    }
