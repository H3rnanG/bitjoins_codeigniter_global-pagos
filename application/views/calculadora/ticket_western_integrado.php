                ...
                <div class="sidebar h-sidebar navbar-collapse ace-save-state">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane in active" id="home">
                      ...
                      <form name="frm" id="frm" method="POST" target="_blank" action="<?php echo base_url('calculadora/ticketwestern_integrado') ?>">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="widget-main">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                          ...
                                          <input type="hidden" name="ori_crg" id="ori_crg">
                    ...
                    <div class="tab-pane" id="form">
                      ...
                      <form name="frmco" id="frmco" method="POST" target="_blank" action="<?php echo base_url('calculadora/ticketwestern_integrado') ?>">
                        <div class="row">
                            <div class="col-md-12">
                              <div class="widget-box">
                                 <div class="widget-header">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                              <div class="input-group">
                                                <span class="input-group-addon">CARGO 2</span>
                                                <input class="form-control" type="text" id="co_ing_crg_2" name="co_ing_crg_2" autocomplete="off" readonly >
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <input type="hidden" id="co_ing_tipo" name="co_ing_tipo" value="3" >
                                          <input type="hidden" id="co_ing_com" name="co_ing_com" value="<?php echo $cargo ?>" >
                                        ...
                                        <div class="col-sm-4">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                              <label><input type="radio" name="opt" id="co_opt" class="co_opt form-control co_cl3" value="3"> Formato 3</label>
                                            </div>
                                          </div>
                                          <div class="space-6"></div>
                                          <div class="row">
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="input-group">
                                                <span class="input-group-addon">CARGO&nbsp;&nbsp;</span>
                                                <input class="form-control" type="text" id="co_edt_cargo" name="co_edt_cargo" readonly >
                                                <span class="input-group-addon fdxklg1">CLP</span>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <label for="adjticket">Adjuntar PDF</label>
                                              <input type="file" name="co_adjticket" id="co_my-file-input-1" class="co_file-adj" data-frm="#frmco" data-action="<?php echo base_url('calculadora/upload_ticket'); ?>" data-carpeta="<?php echo base_url('uploads/') ?>" />
