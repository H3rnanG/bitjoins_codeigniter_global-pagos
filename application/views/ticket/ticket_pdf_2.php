...
if(strlen($formato)>0){
    ...
    if($edt_appago){
        ...
        $obpdf->SetFont('Helvetica', '', '7');
        $pt2_pos4 = 193;
        $obpdf->Image($imgpath, 175, $pt2_pos4, 30, 2.8, 'JPG', '', '', false, 300, '', false, false, 0, false, false, false);
        $obpdf->writeHTMLCell(35.2, 3, 172, $pt2_pos4, $edt_tc, 0, 0, 1, true, 'R', false); 

        $pt2_pos5 = 198.6;
        $obpdf->Image($imgpath, 175, $pt2_pos5, 30, 4.2, 'JPG', '', '', false, 300, '', false, false, 0, false, false, false);
        $obpdf->writeHTMLCell(35.2, 3, 172, $pt2_pos5, $edt_appago, 0, 0, 1, true, 'R', false); 
    }
