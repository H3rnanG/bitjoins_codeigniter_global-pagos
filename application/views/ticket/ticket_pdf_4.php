...
if(strlen($formato)>0){
    ...
    if($print){
        ...
        if($mnt_total){
            ...
            $obpdf->writeHTMLCell(35.2, 3, 172.1, $pt2_pos1, $mnt_total_1, 0, 0, 1, true, 'R', false); 
        } // fin if mnt_total
        ...
        if($edt_sbt){
            ...
            $obpdf->writeHTMLCell(35.2, 3, 172.1, $pt2_pos2, $edt_sbt_1, 0, 0, 1, true, 'R', false); 
            ...
            $obpdf->writeHTMLCell(35.2, 3, 172.1, $pt2_pos3, $edt_sbt_1, 0, 0, 1, true, 'R', false); 
        ...
        if($edt_appago){
            ...
            $obpdf->writeHTMLCell(35.2, 3, 172.1, $pt1_pos4, $edt_tc_1, 0, 0, 1, true, 'R', false); 

            $pt1_pos5 = 76.4;
            $obpdf->Image($imgpath, 175, $pt1_pos5, 30, 4.2, 'JPG', '', '', false, 300, '', false, false, 0, false, false, false);
            $obpdf->writeHTMLCell(35.2, 3, 172.1, $pt1_pos5, $edt_appago_1, 0, 0, 1, true, 'R', false); 
        }
    ...
    if($mnt_total){
        ...
        $pt2_pos1 = 178.6;
        $obpdf->Image($imgpath, 175, $pt2_pos1, 30, 3, 'JPG', '', '', false, 300, '', false, false, 0, false, false, false);
        $obpdf->writeHTMLCell(35.2, 3, 172.1, $pt2_pos1, $mnt_total, 0, 0, 1, true, 'R', false); 
    } // fin if mnt_total

    if($edt_crg){
        $edt_crg = number_format($edt_crg, 0, '.', ',');
        $pt2_pos_crg = 181.4;
        $obpdf->Image($imgpath, 175, $pt2_pos_crg, 30, 3, 'JPG', '', '', false, 300, '', false, false, 0, false, false, false);
        $obpdf->writeHTMLCell(35.2, 3, 172.1, $pt2_pos_crg, $edt_crg, 0, 0, 1, true, 'R', false); 
    } // fin if edt_crg
    ...
    if($edt_sbt){
        ...
        $pt2_pos2 = 186.8;
        $obpdf->Image($imgpath, 175, $pt2_pos2, 30, 3, 'JPG', '', '', false, 300, '', false, false, 0, false, false, false);
        $obpdf->writeHTMLCell(35.2, 3, 172.1, $pt2_pos2, $edt_sbt, 0, 0, 1, true, 'R', false); 

        $obpdf->SetFont('helveticaB', '', '6.7');
        $imgpath2 = dirname($_SERVER["SCRIPT_FILENAME"])."/assets/images/capa-espacio-gris.jpg";
        $pt2_pos3 = 190;
        $obpdf->Image($imgpath2, 175, $pt2_pos3, 30.2, 2.70, 'JPG', '', '', false, 300, '', false, false, 0, false, false, false);
        $obpdf->writeHTMLCell(35.2, 3, 172.1, $pt2_pos3, $edt_sbt, 0, 0, 1, true, 'R', false); 
