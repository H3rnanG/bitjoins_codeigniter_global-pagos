...
<html lang="es">
  ...
  <body class="no-skin">
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  <div class="input-group">
                                    ...
                                    <select name="ing_tipo2" id="ing_tipo2" class="form-control">
                              ...
                              <div class="row">
                                <div class="col-sm-5">
                                  <div class="input-group">
                                    ...
                                    <input type="number" name="ing_iva" id="ing_iva" value="19">
                                  </div>
                                </div>
    ...
    <script type="text/javascript"> 
        ace.vars['base'] = '..'; 
        MyApp.ticketwestern.init();
        //$('#ing_mnt').numeric({altDecimal: ',', decimal: '.', decimalPlaces: 2});
    </script>
